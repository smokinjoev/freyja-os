...
PERSISTENT_AGENTS: tuple[PersistentAgent, ...] = (
    PersistentAgent(
        ...
        tool_grants=frozenset({"web.search", "weather.current", "browser.control", "calendar.read", "email.read", "messaging.send", "home-assistant.control", "macagent.apple", "vision.inspect", "music.control", "scheduling.create", "memory.shared"}),
    ...
    PersistentAgent(
        ...
        tool_grants=frozenset({"web.search", "weather.current", "calendar.read", "email.read", "messaging.send", "macagent.apple", "shell.run", "filesystem.read", "filesystem.write", "git.inspect", "git.write", "coding.execute", "documents.process", "vision.inspect", "memory.private", "memory.shared"}),
    ...
    PersistentAgent(
        ...
        tool_grants=frozenset({"web.search", "weather.current", "calendar.read", "email.read", "messaging.send", "documents.process", "vision.inspect", "memory.private", "memory.shared"}),
    ...
    PersistentAgent(
        ...
        tool_grants=frozenset({"web.search", "weather.current", "calendar.read", "messaging.send", "vision.inspect", "memory.private", "memory.shared"}),
