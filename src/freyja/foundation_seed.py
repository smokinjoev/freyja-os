...
INFERENCE_ENDPOINTS: tuple[InferenceEndpoint, ...] = (
    ...
    InferenceEndpoint(
        ...
        capabilities=frozenset({"general.large", "reasoning"}),
        security_domain_id=SecurityDomainId.HOUSEHOLD,
        priority=8,
    ),
    InferenceEndpoint(
    ...
    InferenceEndpoint(
        ...
        capabilities=frozenset({"vision.large", "document_review"}),
        security_domain_id=SecurityDomainId.HOUSEHOLD,
        priority=8,
    ),
    InferenceEndpoint(
    ...
    InferenceEndpoint(
        ...
        capabilities=frozenset({"general.large", "chat", "reasoning"}),
        security_domain_id=SecurityDomainId.HOUSEHOLD,
        priority=20,
    ),
    InferenceEndpoint(
        ...
        base_url="http://100.94.80.21:11434",
        model="qwen2.5vl:72b",
        capabilities=frozenset({"general.deep", "reasoning.deep", "long_context"}),
        security_domain_id=SecurityDomainId.HOUSEHOLD,
        priority=30,
    ),
    InferenceEndpoint(
