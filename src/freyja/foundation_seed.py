...
PERSISTENT_AGENTS: tuple[PersistentAgent, ...] = (
    PersistentAgent(
        ...
        tool_grants=frozenset({"web.search", "weather.current", "browser.control", "calendar.read", "email.read", "messaging.send", "home-assistant.control", "macagent.apple", "vision.inspect", "music.control", "scheduling.create", "memory.shared", "system.health"}),
