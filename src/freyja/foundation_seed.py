...
PERSISTENT_AGENTS: tuple[PersistentAgent, ...] = (
    ...
    PersistentAgent(
        ...
        tool_grants=frozenset({"web.search", "weather.current", "browser.control", "calendar.read", "email.read", "messaging.send", "macagent.apple", "shell.run", "filesystem.read", "filesystem.write", "git.inspect", "git.write", "coding.execute", "documents.process", "vision.inspect", "music.control", "memory.private", "memory.shared", "system.health"}),
    ...
    PersistentAgent(
        ...
        tool_grants=frozenset({"web.search", "weather.current", "browser.control", "calendar.read", "email.read", "messaging.send", "documents.process", "vision.inspect", "music.control", "memory.private", "memory.shared", "system.health"}),
    ...
    PersistentAgent(
        ...
        tool_grants=frozenset({"web.search", "weather.current", "browser.control", "calendar.read", "email.read", "messaging.send", "vision.inspect", "music.control", "memory.private", "memory.shared", "system.health"}),
