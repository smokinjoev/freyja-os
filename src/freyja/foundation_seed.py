...
TOOL_CAPABILITIES: tuple[ToolCapabilityGrant, ...] = (
    ...
    ToolCapabilityGrant(tool_id="calendar.write", category="calendar", display_name="Calendar write", required_permission="tool:calendar.write", mutation=True, machine_affinity="iris"),
