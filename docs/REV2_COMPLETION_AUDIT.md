...
Do not mark the Freya 2.0 goal complete until the Signal onboarding gap is
resolved or explicitly accepted as an external-service action item under the
active goal's completion criteria.
