...
- Added `scripts/freyja5-export-agent-definitions.py` to export non-secret
  Freyja 5 agent, route, Gateway policy, MCP server, and per-agent MCP grant
  posture from source control for Atlas/Msty Go compatibility validation.
