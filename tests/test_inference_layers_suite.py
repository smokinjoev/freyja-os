...
def test_inference_layer_suite_has_100_cases_and_layer_coverage() -> None:
    suite = load_suite("routing/inference_layers")
...
@pytest.mark.asyncio
async def test_inference_layer_suite_matches_atlas_routing_policy(monkeypatch: pytest.MonkeyPatch) -> None:
