...
def test_bundle_contains_required_deliverable_sections() -> None:
    ...
    assert any("Telegram getUpdates poller" in action for action in bundle["external_gates"][2]["next_actions"])
    ...
    assert any("Telegram getUpdates poller" in action for action in bundle["evidence_summary"]["readiness_required_next_actions"])
