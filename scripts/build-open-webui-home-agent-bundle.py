...
def build_bundle(now: int | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "artifacts": {
            ...
            "channels_compose": "deploy/compose/freyja-channels/compose.yaml",
        ...
        "evidence_summary": {
            ...
            "home_memory_joe_write_ok": _check_ok(live, "home_memory_joe_write"),
            "home_memory_joe_read_ok": _check_ok(live, "home_memory_joe_read"),
            "home_memory_recent_events_ok": _check_ok(live, "home_memory_recent_events"),
            "home_memory_beth_denied_joe_scope_ok": _check_ok(live, "home_memory_beth_denied_joe_scope"),
            ...
            "resource_export_tool_count": len(resources.get("tools") or []),
            "resource_export_native_memory_mode": (resources.get("native_memory") or {}).get("mode"),
            ...
            "proactive_job_candidate_counts": proactive.get("job_candidate_counts") or {},
            "proactive_blocked_by_job": proactive.get("blocked_by_job") or {},
            ...
            "tools_gateway_child_allowed_operations": tools_gateway.get("child_allowed_operations") or [],
            "tools_gateway_destructive_default_all_deny": tools_gateway.get("destructive_default_all_deny"),
            "tools_gateway_live_side_effects_invoked": tools_gateway.get("live_side_effects_invoked"),
            "tools_gateway_execution_statuses": tools_gateway.get("execution_statuses") or {},
...
def render_markdown(bundle: dict[str, Any]) -> str:
    ...
    lines += [
        ...
        f"- `telegram_allowlist_count`: `{evidence['telegram_allowlist_count']}`",
        f"- `telegram_identity_map_count`: `{evidence['telegram_identity_map_count']}`",
        f"- `signal_empty_allowlist_policy`: `{evidence['signal_empty_allowlist_policy']}`",
        f"- `signal_allowlist_count`: `{evidence['signal_allowlist_count']}`",
        f"- `signal_identity_map_count`: `{evidence['signal_identity_map_count']}`",
        ...
        f"- Job candidate counts: `{evidence['proactive_job_candidate_counts']}`",
        f"- Blocked by job: `{evidence['proactive_blocked_by_job']}`",
